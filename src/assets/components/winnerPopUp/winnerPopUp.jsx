...
export default function WinnerPopUp({winner, closePopUp, playAgain}){
    return (
        <div className='bg-black bg-opacity-75 w-full h-full fixed z-10 top-0 flex justify-center items-center'>
            <div className="winnerPopUp  flex flex-col items-center justify-center w-4/5 xl:w-1/4 h-1/2  rounded-xl overflow-x-hidden">
